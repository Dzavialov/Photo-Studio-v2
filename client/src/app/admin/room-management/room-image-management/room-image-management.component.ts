...
@Component({
  selector: 'app-room-image-management',
  templateUrl: './room-image-management.component.html',
  styleUrls: ['./room-image-management.component.css']
})
export class RoomImageManagementComponent implements OnInit{
  room: Room | undefined;
