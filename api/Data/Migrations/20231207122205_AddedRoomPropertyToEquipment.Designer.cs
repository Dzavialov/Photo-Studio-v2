...
namespace api.Data.Migrations
{
    ...
    [Migration("20231207122205_AddedRoomPropertyToEquipment")]
    partial class AddedRoomPropertyToEquipment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Entities.EditItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Entities.RoomImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Entities.EquipmentItemImage", b =>
                {
                    b.HasOne("api.Entities.EquipmentItem", "Equipment")
                        .WithOne("Image")
                        .HasForeignKey("api.Entities.EquipmentItemImage", "EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
